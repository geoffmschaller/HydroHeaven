...
export default class NavigationBar extends React.Component {
	...
	render() {
		...
		let sliderClasses = this.state.drawerOpen ? styles.slider : [styles.slider, styles.closedSlider].join(" ");
					...
					<div className={styles.desktop}>
						<Link to={"/service-contact"}>
							<div className={styles.menuItem}>
								<i className="fad fa-tools"/> SERVICE & CONTACT
							</div>
						</Link>
						<Link to={"/bbq-islands"}>
							<div className={styles.menuItem}>
								<i className="fad fa-fire"/> BBQs
							</div>
						</Link>
						<Link to={"/swim-spas"}>
							<div className={styles.menuItem}>
								<i className="fad fa-swimmer"/> SWIM SPAS
							</div>
						</Link>
						<Link to={"/spas-hot-tubs"}>
							<div className={styles.menuItem}>
								<i className="fad fa-hot-tub"/> HOT TUBS & SPAS
							</div>
						</Link>
						<Link to={"/"}>
							<div className={styles.menuItem}>
								<i className="fad fa-home-alt"/> HOME
							</div>
						</Link>
						<div className="clear"/>
					</div>
