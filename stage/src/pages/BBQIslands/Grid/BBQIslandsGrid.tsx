		...
		return (
			<div className={styles.bbqIslandsMain}>
				...
				<div className={styles.warranty}>
					...
					<div className={styles.description}>Bull is so confident in its fabulous lineup of premium outdoor grills that Lifetime Warranties* come standard on all fire
						boxes, cooking grates and on all cast stainless steel burners. With 9 durable grill heads to choose from, Bull has the perfect grill just for you.
					</div>
