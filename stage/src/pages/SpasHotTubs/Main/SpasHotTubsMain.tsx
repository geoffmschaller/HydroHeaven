...
import ShopByInterface from "../../../interfaces/ShopByInterface";
import SpaMainFeaturesInterface from "../../../interfaces/SpaMainFeaturesInterface";
...
import BrochuresInterface from "../../../interfaces/BrochuresInterface";
...
class SpasHotTubsMain extends React.Component {
	...
	features: Array<SpaMainFeaturesInterface> = [
		{
			...
			image: require('../../../static/images/features/lights.jpg')
		},
		{
			...
			image: require('../../../static/images/features/insulation.jpg')
		},
		{
			...
			image: require('../../../static/images/features/massage.jpg')
		},
		{
			...
			image: require('../../../static/images/features/ozonator.jpg')
		}
	];

	brochures: Array<BrochuresInterface> = [
		{
			name: "American Whirlpool Brochure",
			link: require('../../../static/pdfs/brochures/AmericanWhirlpoolBrochure.pdf')
		},
		{
			name: "Vita Spas Brochure",
			link: require('../../../static/pdfs/brochures/VitaSpasBrochure.pdf')
		}
	];
